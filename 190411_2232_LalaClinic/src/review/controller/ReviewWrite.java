...
public class ReviewWrite extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		System.out.println("ReviewWrite doGet");


		resp.sendRedirect("./Review/reviewWrite.jsp");		
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		System.out.println("ReviewWrite doPost");
		...
		boolean isS = dao.insertReview(new ReviewDto(0, id, title, content, filename[0], filename[1], management));

		if(isS){
			System.out.println("리뷰 글쓰기 성공!");		
			resp.sendRedirect("reviewList");
			
		}else{
			System.out.println("리뷰 글쓰기 실패!");
			resp.sendRedirect("reviewList");		
		}	
