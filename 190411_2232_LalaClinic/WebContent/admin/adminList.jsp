...
<p align ="right" style="font-size: 13px">
	...
	<a href="/LalaClinic/AdminList"><span class="bold">관리자목록</span></a>
</p>
</section>
...
<tbody>
	...
	<c:forEach items="${list}" var="m">
		<tr>
			...
			<td><a href="AdminDetail?id=${m.id}">${m.id}</a></td>
			<td>${m.name}</td>
			<td>${m.gender}</td>
		</tr>
	</c:forEach>
...
<div class="clear"></div>
<div class="search01">
<form action="/LalaClinic/AdminList" onsubmit="return check()">
...
<!-- <input type="button" value="관리자 메인" onclick="location.href='admin/adminMain.jsp'"> -->
</div>
