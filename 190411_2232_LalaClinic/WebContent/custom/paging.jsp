...
function gotoPage(pageNum) {
    ...
    // alert(choice);
     //alert(findWord);
    location.href="./customList?nowPage="+now+"&choice=" + choice + "&findWord="+findWord;
}
...
String findWord = request.getParameter("findWord");
String choice = request.getParameter("choice");
System.out.println("paging  find : " + findWord);
System.out.println("paging choice : " + choice);
if(findWord == null ){
   choice = "sel";
}
...
<form action="<%=actionPath %>" name="frmPaging" method="get" id="frmPaging">
   <input type="hidden" name="nowPage" id="nowPage">
   <input type="hidden" name="findWord" value="<%=findWord %>">
<input type="hidden" name="search" value="<%=findWord %>" id="findWord">
