...
<title>adminUpdateView.jsp</title>
</head>
...
<div class ="tb_Head01">
<form action="/LalaClinic/AdminUpdate" method="post" onsubmit="return check()">
...
<tr>
	<td colspan="2" class="myDetailRight">
		<button type="submit" class="btn btn-outline-primary" onclick="location.href='/LalaClinic/AdminUpdate">수정</button>
		<button type="button" class="btn btn-outline-success" onclick="location.href='/LalaClinic/AdminList'">목록</button>
