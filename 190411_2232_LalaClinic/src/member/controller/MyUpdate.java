...
@WebServlet(urlPatterns="/MyUpdate")
public class MyUpdate extends HttpServlet {

	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		System.out.println("MyUpdate get");
	}

	@Override
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		System.out.println("MyUpdate post");
		...
		msg = "<script>alert('" + msg + "'); location.href='/LalaClinic/MyDetail?id="+id+"';</script>";
		out.println(msg);
