...
@WebServlet(urlPatterns="/CalendarDayList")
public class CalendarDayList extends HttpServlet {

	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		System.out.println("CalendarDayList doget");
		...
		List<CombineDto> list = dao.getDayList(id, rdate);
		
		req.setAttribute("list", list);
		req.getRequestDispatcher("/mypage/myDayList.jsp").forward(req, resp);
	}
