...
<p align ="right" style="font-size: 13px">
	...
	<a href="/LalaClinic/admin/adminJoin.jsp"><span class="bold">관리자등록</span></a>
</p>
</section>
...
<div align="center">
	...
	<a href="/LalaClinic/admin/adminMain.jsp">
...
<!-- <input type="button" value="관리자 메인" onclick="location.href='./adminMain.jsp'"> -->
