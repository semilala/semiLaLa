...
@WebServlet(urlPatterns="/AdminCalendarView")
public class AdminCalendarView extends HttpServlet {

	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		System.out.println("AdminCalendarView doget");
		...
		iCalendarDao dao = CalendarDao.getInstance();
		List<CombineDto> list = dao.getCalendarListAll(year+UtilClass.two(month+""));
	
		System.out.println("11111: " + id + ", " + year + ", " + month);
		System.out.println("size: " + list.size());
		
		req.setAttribute("list", list);
		req.getRequestDispatcher("/admin/adminCalendar.jsp").forward(req, resp);
	}

	@Override
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		System.out.println("AdminCalendarView dopost");
	}
}
